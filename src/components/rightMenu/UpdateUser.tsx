            ...
            <form action={(formData) => formAction({formData, cover:cover?.secure_url || ""})} className='p-12 bg-white rounded-lg shadow-md flex flex-col gap-2 w-full md:w-1/2 xl:w-1/3 relative'>
                ...
                <div className='flex flex-wrap justify-between gap-2 xl:gap-4'>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <input type='text' placeholder={user.description || "Life is beautiful...."} className=' ring-1 ring-gray-300 p-[13px] rounded-md text-sm' name='description'/>
                    </div>
                    {/* INPUT */}
                    <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <input type='text' placeholder={user.school || "MIT"} className='ring-1 ring-gray-300 p-[13px] rounded-md text-sm' name='school'/>
                    </div>
                    {/* INPUT */}
                    <div className='flex flex-col gap-4'>
                        <label htmlFor="" className="text-xs text-gray-500">Work</label>
                        <input type='text' placeholder={user.work || "Apple Inc."} className='ring-1 ring-gray-300 p-[13px] rounded-md text-sm' name='work'/>
                    </div>
                    {/* INPUT */}
                    <div className='flex flex-col gap-4'>
                        <label htmlFor="" className="text-xs text-gray-500">Website</label>
                        <input type='text' placeholder={user.website || "lama.dev"} className='ring-1 ring-gray-300 p-[13px] rounded-md text-sm' name='website'/>
                    </div>
                </div>
                <UpdateButton/>
